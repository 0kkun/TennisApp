...
class CreateRankingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('rankings', function (Blueprint $table) {
            ...
            $table->integer('most_heighest')->length(4)->nullable()->comment('これまでの一番高いランキング');
            ...
            $table->string('current_tour_result', 50)->commnet('現在参加している大会の結果');
            $table->string('pre_tour_result', 50)->comment('前回大会の結果');
