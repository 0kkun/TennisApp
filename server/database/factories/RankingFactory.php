...
$factory->define(Ranking::class, function (Faker $faker) {
    return [
        ...
        'current_tour_result_en'    => $faker->realText($maxNbChars = 50, $indexSize = 2),
        'current_tour_result_jp'    => $faker->realText($maxNbChars = 50, $indexSize = 2),
        'pre_tour_result_en'        => $faker->realText($maxNbChars = 50, $indexSize = 2),
